...
main (int argc, char *argv[])
{
  ...
  ueStaticRouting->AddNetworkRouteTo (Ipv4Address ("13.0.0.3"), Ipv4Mask ("255.255.255.255"),
  ...
  rightStaticRouting->AddNetworkRouteTo (Ipv4Address ("11.0.0.3"), Ipv4Mask ("255.255.255.255"),
  ...
  pingApp2->SetAttribute ("Remote", Ipv4AddressValue (Ipv4Address("13.0.0.3")));
